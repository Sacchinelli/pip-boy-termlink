...
- **Toque numa palavra para perguntar por ela.** Na fala do tutor, cada palavra é um alvo: passar o cursor acende a palavra na cor do tema e clicar escreve *“O que significa ‘stimpaks’?”* no campo de texto, sem enviar. Em repouso não há marca nenhuma — uma fala inteira sublinhada não se lê —, e selecionar o texto continua valendo. É o gesto que faltava: a palavra desconhecida está no meio da frase, e perguntar por ela exigia digitá-la de novo.
